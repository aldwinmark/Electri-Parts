...
Public Class frmPrintSales
    ...
    Private Sub btnPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintPreview.Click
        ...
        If frmMain.ToolStripStatuslblLevel.Text = "1" Then
            If Me.rbtnCustomer.Checked = True Then
                repDoc = New SalesByCustomerDetail_Customer
            ElseIf Me.rbtnDate.Checked = True Then
                repDoc = New SalesByCustomerDetail_Date
            ElseIf Me.rbtnDR.Checked = True Then
                repDoc = New SalesByCustomerDetail_DRNo
            Else
                repDoc = New SalesByCustomerDetail_ItemNo
            End If
        Else
            If Me.rbtnCustomer.Checked = True Then
                repDoc = New SalesByCustomerDetail_UCustomer
            ElseIf Me.rbtnDate.Checked = True Then
                repDoc = New SalesByCustomerDetail_UDate
            ElseIf Me.rbtnDR.Checked = True Then
                repDoc = New SalesByCustomerDetail_UDRNo
            Else
                repDoc = New SalesByCustomerDetail_UItemNo
            End If
        End If
