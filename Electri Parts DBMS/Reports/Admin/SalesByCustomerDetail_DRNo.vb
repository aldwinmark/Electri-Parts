...
Public Class SalesByCustomerDetail_DRNo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SalesByCustomerDetail_DRNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesByCustomerDetail_DRNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesByCustomerDetail_DRNo = New SalesByCustomerDetail_DRNo
        rpt.Site = Me.Site
        Return rpt
    End Function
