...
Public Class SalesByCustomerDetail_Date
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SalesByCustomerDetail_Date.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesByCustomerDetail_Date
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesByCustomerDetail_Date = New SalesByCustomerDetail_Date
        rpt.Site = Me.Site
        Return rpt
    End Function
