...
Public Class SalesByCustomerDetail_UDRNo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SalesByCustomerDetail_UDRNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesByCustomerDetail_UDRNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesByCustomerDetail_UDRNo = New SalesByCustomerDetail_UDRNo
        rpt.Site = Me.Site
        Return rpt
    End Function
