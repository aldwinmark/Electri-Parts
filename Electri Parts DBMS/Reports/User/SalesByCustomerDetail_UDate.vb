...
Public Class SalesByCustomerDetail_UDate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SalesByCustomerDetail_UDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesByCustomerDetail_UDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesByCustomerDetail_UDate = New SalesByCustomerDetail_UDate
        rpt.Site = Me.Site
        Return rpt
    End Function
