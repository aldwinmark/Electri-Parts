...
Public Class SalesByCustomerDetail_UItemNo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SalesByCustomerDetail_UItemNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesByCustomerDetail_UItemNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesByCustomerDetail_UItemNo = New SalesByCustomerDetail_UItemNo
        rpt.Site = Me.Site
        Return rpt
    End Function
